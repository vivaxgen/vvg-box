...
# check extra flags from environments

extra_flags = os.environ.get('SNAKEMAKE_CLUSTER_EXTRA_FLAGS', '')

cmd = "qsub -V -S /bin/sh " + extra_flags + " {a}{A}{b}{c}{C}{d}{D}{e}{f}{h}{j}{l}{m}{M}{N}{o}{p}{P}{q}{t}{u}{v}{V}{w}{W}{rp}{dep}{ex}".format(
